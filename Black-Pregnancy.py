    ...
    def run(self):
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                output_text = f"[<>] Reports sent by salvatore=> {total_reports} ({reports_per_second:.2f} reports/min) Current User-Agent: {user_agent} Current Accept-Language: {accept_language}"
...
class TikTokReporterApp(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Black-Pregnancy - TikTok Salva Report Tool")
...
'''
  +-------------------------------------------------------+
  |Rporting Tools TikTok Account Frs => @double0<>@Elmafia|
  +---------------------------+---------------------------+                                                                                                                                                
  |      __________________   |                           |             ##########################                                                                                                                                                
  |  ==c(______(o(______(_()  | |""""""""""""|======[***  |            #        Copyrit of      #                                                                                                                          
  |             )=\           | |  Salvatore \            |           #   salvatore <>         #                                                                                                                          
  ...
  +---------------------------+---------------------------+                                                                                                                                                
  |      o O o                |        \'\/\/\/'/         |     ++++++++++++++++++++++++++++++++++++++++                                                                                                                                           
  |              o O          |         )======(          |     + Disclaimer This Tools For Cyber-Sec  +                                                                                                     
  |                 o         |       .'  LOOT  '.        |     ++++++++++++++++++++++++++++++++++++++++                                                                                                                                           
  | |^^^^^^^^^^^^^^|l___      |      /    _||__   \       |                + Black-Pregnancy +                                                                                                                    
  | |  Reporter <>   |""\___, |     /    (_||_     \      |                +++++++++++++++++++                                                                                                                                 
  | |________________|__|)__| |    |     __||_)     |     |   # Script coded by Salvatore For Report Tik Tok                                                                                                                                      
  | |(@)(@)"""**|(@)(@)**|(@) |    "       ||       "     |                                                                                                                                                
  |  = = = = = = = = = = = =  |     '--------------'      |                                                                                                                                                
  +---------------------------+---------------------------+                                                                                                                                                  
'''
        ...
        self.url_label = QLabel("Set Your URL For Account ==>")
        ...
        self.poison_button = QPushButton("Attack Target By <>......")
